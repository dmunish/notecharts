...
def _load_palette_from_palettable(palette_name: str) -> List[Tuple[float, float, float]]:
    ...
    try:
        ...
        elif isinstance(palette_obj, type):
            raise ValueError(
                f"'{palette_name}' resolves to a class ({module_path}), not a palette "
                "instance. This entry is not a usable palette and has been removed "
